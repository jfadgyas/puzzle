...
const About = () => {
    return (
        <main>
            <h1>About Puzzle Plaza</h1>
            <h2>Welcome to **Puzzle Mania**, the ultimate destination for jigsaw puzzle lovers!</h2>
            <p>
                Welcome to **Puzzle Mania**, the ultimate destination for jigsaw puzzle lovers!

                We are passionate puzzle enthusiasts who have spent countless hours solving jigsaws of all shapes and sizes. This year, we decided to take our passion to the next level by creating **Puzzle Mania**, an online store dedicated to providing high-quality puzzles to fellow enthusiasts around the world.
