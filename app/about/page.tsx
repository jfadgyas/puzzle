        ...
        <main className={style.about} id='about'>
            <section className={style.hero} id='hero'>
                ...
                <p className={style.desc}>
                    We are passionate puzzle enthusiasts who have spent countless hours solving jigsaws of all shapes and sizes. This year, we decided to take our passion to the next level by creating <span className={style.company}>Puzzle Plaza</span>, an online store dedicated to providing high-quality puzzles to fellow enthusiasts around the world.
                </p>
            </section>            
            <section className={style.content} id='journey'>
                <div className={style.textSection}>
                    ...
                    <p className={style.desc}>
                        ...
                        That&apos;s why, in 2024, we founded <span className={style.company}>Puzzle Plaza</span>. We wanted to share our passion with the world and offer a curated selection of puzzles for all skill levels – from beginners to advanced puzzlers.
            ...
            <section className={style.content} id='mission'>
                <div className={style.textSection}>
                    <h2 className={style.heading}>Our Mission</h2>
                    <p className={style.desc}>
                        At <span className={style.company}>Puzzle Plaza</span>, our mission is simple:  
                        To bring the joy of puzzles to everyone, one piece at a time. We believe that jigsaw puzzles are not just for fun but also a way to unwind, challenge your mind, and even bond with family and friends. That&apos;s why we are committed to offering a wide variety of puzzles, from beautiful landscapes and intricate designs to fun and educational themes for kids.
                    </p>
                </div>
                <div className={style.imageSection}>
                    <Image
                        className={style.image}
                        src='/familypuzzle.webp'
                        alt='family'
                        fill
                        sizes="calc(100vw - 32px)"
                    />
            ...
            <section className={style.content} id='join'>
                <div className={style.textSection}>
                    ...
                    <p className={style.desc}>
                        ...
                        Thank you for visiting <span className={style.company}>Puzzle Plaza</span>, and happy puzzling!
                    </p>
                    <div className={style.imageSection}>
                        <Image
                            className={style.image}
